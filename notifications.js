// assets/js/notifications.js - VERSIÓN COMPLETA CORREGIDA
...
export class NotificationManager {
    ...
    async registerServiceWorker() {
        try {
            ...
            // Suscribirse a push notifications (solo si hay clave VAPID válida)
            if (this.permission === 'granted' && this.isValidVapidKey()) {
    ...
    isValidVapidKey() {
        // Verificar si la clave VAPID es válida (no vacía y no es el placeholder)
        return this.vapidPublicKey && 
               this.vapidPublicKey !== '' && 
               this.vapidPublicKey !== 'TU_CLAVE_PUBLICA_VAPID';
    }
    ...
    async requestPermission() {
        ...
        try {
            ...
            // Si se otorga permiso, suscribirse a push (solo si hay clave válida)
            if (this.permission === 'granted' && this.serviceWorkerRegistration && this.isValidVapidKey()) {
                await this.subscribeToPush();
            }
    ...
    getStats() {
        return {
            ...
            pushEnabled: !!this.serviceWorkerRegistration && this.isValidVapidKey(),
