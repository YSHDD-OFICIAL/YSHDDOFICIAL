// assets/js/main.js - VERSIÓN FINAL 2.6.0 CORREGIDA
...
class YSHDDEPK {
    ...
    initForms() {
        ...
        if (contactForm) {
            ...
            if (this.modules.validator && this.modules.validator.setupLiveValidation) {
            ...
            contactForm.addEventListener('submit', async (e) => {
                ...
                if (this.modules.validator && this.modules.validator.validateContactForm) {
                    validation = this.modules.validator.validateContactForm(data);
                }
                
                if (!validation.isValid) {
                    if (this.modules.validator && this.modules.validator.displayErrors) {
        ...
        if (collabForm) {
            collabForm.addEventListener('submit', async (e) => {
                ...
                if (this.modules.validator && this.modules.validator.validateCollaborationForm) {
                    validation = this.modules.validator.validateCollaborationForm(data);
                }
    ...
    async submitContactForm(form, data) {
        ...
        try {
            ...
            form.reset();
            if (this.modules.validator && this.modules.validator.clearErrors) {
    ...
    async submitCollaborationForm(form, data) {
        ...
        try {
            ...
            if (this.modules.analytics) {
                this.modules.analytics.trackEvent('collaboration', 'proposal_submit', data.collabRole || 'unknown');
            }
    ...
    initFloatingActions() {
        ...
        if (backToTop) {
            backToTop.addEventListener('click', () => {
                this.utils.scrollToElement(document.body, 0);
                if (this.modules.analytics) {
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        window.addEventListener('error', (event) => {
            ...
            if (window.yshddApp) {
                if (window.yshddApp.modules.analytics) {
